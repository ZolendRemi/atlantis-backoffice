 ...
 */
final class Version20190615160801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users_devices (users_id INT NOT NULL, devices_id INT NOT NULL, INDEX IDX_E1073A5067B3B43D (users_id), INDEX IDX_E1073A50665B0F2F (devices_id), PRIMARY KEY(users_id, devices_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
